...
import com.kopever.peach.service.eleme.domain.vo.ElemeAnchor;
...
//    private static final String ELEME_COUPON_URL = "https://h5.ele.me/restapi/marketing/promotion/weixin/oEGLvjh2WrbnkReLy7zex5KgTJ9A";
    ...
    public ElemeCouponResponseVO getElemeLuckyCoupon(
            BigInteger userId, String couponUrl) throws UnsupportedEncodingException, MalformedURLException {
    ...
    private ElemeCouponResponseVO getElemeLuckyCoupon(BigInteger userId, String sn, String luckyNumber) {
